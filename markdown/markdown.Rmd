...
```{r, fig.height=8, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r echo= FALSE, message = FALSE, warning = FALSE, fig.width = 10, fig.heigth = 2, include=FALSE}
...
An average data scientist is able to use the above listed algorithms and methods as basic hard skills to meet the standard industry expectations.
